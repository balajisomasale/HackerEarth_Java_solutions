/*
Balu Hint : the solution is you have to find the index at which position vowel present then simple apply this formula ====>>> count + (string.length()-index)*(index+1) .
keep in mind you should count this in long datatype other wise it will give an error
